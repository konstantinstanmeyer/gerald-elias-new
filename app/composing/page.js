        ...
        <main id="composing">
            ...
            <section id="composing-content">
                <div className="composition-card">
                    ...
                    <h3>Chamber Music</h3>
                    <p>
                        String Quartet No. 1: "When Mr. Mozart Went to the Ball." Variations (a la 
                        Young Persons Guide to the Orchestra by Benjamin Britten) on Mozart's Violin 
                        Sonata in G Major, K.379, for string quartet and narrators
                    </p>
                    ...
                    <p className="section-bottom">
                        "Dear Great Salt Lake," for narrator, violin, flute, and cimbalom. 
                        (Co-composed with Igor Iachimciuc, poem by Raisa Tolchinsky)
                    </p>
                    <h3>Orchestra</h3>
                    <p>
                        Transcription of the Aaron Copland Sonata for violin and orchestra. 
                        [Pub. Boosey & Hawkes]
                    </p>
                    <p>
                        "The Raven," Monodrama for Baritone and Orchestra (also a chamber music version 
                        for voice, viola, and piano), based upon the poem by Edgar Allan Poe
                    </p>
                    ...
                    <p>
                        Transcription of the Andante from Bach's Violin Sonata in A Minor for string 
                        orchestra (can be used as a 2nd mvt. in the 3rd Brandenburg Concerto)
                    </p>
                </div>
            </section>
        </main>

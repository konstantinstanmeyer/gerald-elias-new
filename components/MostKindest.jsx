export default function MostKindest(){
    return (
        <>
            <div id="blog-post-container">
                ...
                <img style={{ display: "flex", width: "80% !important", marginBottom: "3rem", marginTop: "3rem"}} id="blog-post-image" src="/comic.png" />
                <p>
                ...
                <img style={{ display: "flex", marginBottom: "3rem", marginTop: "3rem"}} id="blog-post-image" src="/piano.png" />
                <p>
                ...
                <p>
                    In a related issue, what about repeats in symphonies? Baroque suites and sinfonias were generally five to fifteen minutes long in their entirety. They were often based upon traditional dances and, as such, movements were in bipartite form, each section repeating. In musical terms: A-A, B-B. Over the next several generations, well into the 19<sup>th</sup> and early 20<sup>th</sup> centuries, that form evolved into symphonies that were thirty, forty, fifty, sixty…ninety minutes long. Yet, almost like a vestigial organ, composers often kept those repeat signs at the end of each section. 
                </p>
                <p>
                ...
                <img style={{ display: "flex"}} id="blog-post-image" src="/brahm.png" />
                <h6 style={{ textAlign: "center", fontWeight: "300", fontSize: "12px", marginBottom: "1rem" }}>
                    <em>Brahms conducting</em>
                </h6>
                <p>
